![yamdb_workflow](https://github.com/SmertinKirill/yamdb_final/actions/workflows/yamdb_workflow.yml/badge.svg)
# Yambd
...
+ http://158.160.63.111/api/v1/ - сам проект
+ http://158.160.63.111/admin/ - админ панель
+ http://158.160.63.111/redoc/ - подключена документация API
